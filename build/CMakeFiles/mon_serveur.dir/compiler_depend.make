...
mon_serveur: /lib/x86_64-linux-gnu/libb2.so.1 \
  ...
  /usr/local/lib/libsfml-graphics.so.3.1.0 \
  /usr/local/lib/libsfml-network.so.3.1.0 \
  /usr/local/lib/libsfml-system.so.3.1.0 \
  /usr/local/lib/libsfml-window.so.3.1.0 \
  /usr/local/lib/libtgui.so.1.12.0 \
...
mon_serveur_autogen/mocs_compilation.cpp:
